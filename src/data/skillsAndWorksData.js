...
const skillsData = [
  {
    ...
    details: {
      ...
      icons: [
        { icon: gatsbyIcon, iconAlt: 'gatsby icon' },
        { separator: 'and' },
        { icon: graphQLIcon, iconAlt: 'graph-ql icon' },
        { separator: 'and' },
        { icon: netlifyIcon, iconAlt: 'netlify icon' },
        { separator: 'or' },
        { icon: wordpressIcon, iconAlt: 'wordpress icon' },
        { separator: 'or' },
        { icon: drupalIcon, iconAlt: 'drupal icon' },
      ],
    },
    works: [],
  },
  {
    ...
    details: {
      ...
      icons: [
        { icon: meteorIcon, iconAlt: 'meteor-js icon' },
        { separator: 'and' },
        { icon: reactIcon, iconAlt: 'react icon' },
        { separator: 'and' },
        { icon: nodeJSIcon, iconAlt: 'node-js icon' },
        { separator: 'and' },
        { icon: mongoDBIcon, iconAlt: 'mongo-db icon' },
        { separator: 'or' },
        { icon: phpIcon, iconAlt: 'php icon' },
      ],
    },
    works: [
      {
  ...
  },
  {
    ...
    details: {
      ...
      icons: [
        { icon: reactIcon, iconAlt: 'react icon' },
        { separator: 'or' },
        { icon: meteorIcon, iconAlt: 'meteor icon' },
        { separator: 'or' },
        { icon: androidIcon, iconAlt: 'android icon' },
        { separator: 'and' },
        { icon: javaIcon, iconAlt: 'java icon' },
      ],
    },
    works: [
      {
